...
Commençons tout d'abord par nous renseigner sur les corrélations entre les variables (Figure \ref{fig:correlations}).

\begin{figure}[htp]
    \centering
    \includegraphics[width=0.7\textwidth]{Images/correlations_variables.png}
